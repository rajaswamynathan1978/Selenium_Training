...
public class EventListener_testNG implements ITestListener
{
	...
	{
		mylog.info(String.format("Method %s is Passed From Test %s",result.getName(),result.getTestName()));
	...
	{
		mylog.info(String.format("Method %s is Failed From Test %s",result.getName(),result.getTestName()));
		//System.out.println(String.format("Method %s is Failed From Test %s",result.getName(),result.getTestName()));
	}

	public void onTestSkipped(ITestResult result) 
	{
		mylog.info(String.format("Method %s is Skipped From Test %s",result.getName(),result.getTestName()));
